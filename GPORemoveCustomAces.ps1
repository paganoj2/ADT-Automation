...
Written to remove all unknown and user ACEs on GPOs. User ACEs are created automatically on GPOs whenever they are created but those creating the GPOs should be part of 
an administrative group that permits this. Therefore the user part should be removed so they obtain all their rights from the administrative group. This way if they are ever
removed from the administrative group for whatever reason or have their rights revoked, they no longer have access to the GPOs.
...
$GPOsToCheck = Get-GPO -All


ForEach($GPO in $GPOsToCheck){

# Fetch current permission entries
$GPOPermissions = $GPO.GetSecurityInfo()

# Identify trustees to be removed
[Array]$trusteesToRemove = $GPOPermissions.Trustee | Where-Object { $_.SidType -eq 'Unknown' }
$trusteesToRemove += $GPOPermissions.Trustee | Where-Object { $_.SidType -eq 'User' }

if ($trusteesToRemove){
# Remove them from the permission collection
$trusteesToRemove | ForEach-Object {
    $GPOPermissions.RemoveTrustee($_.Sid)}
...
$GPO.SetSecurityInfo($GPOPermissions)
}
# SIG # Begin signature block
# MIISEwYJKoZIhvcNAQcCoIISBDCCEgACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0Ah9H0ZAhDuqVRgpw10V8bbQ
# ssmggg9rMIIHsTCCBZmgAwIBAgITNQAAACFv8bfVN7E2EQAAAAAAITANBgkqhkiG
...
# IwYJKoZIhvcNAQkEMRYEFMfzDtpZUyHgjYzWz2SPXOTKN52TMA0GCSqGSIb3DQEB
# AQUABIIBAIg2TTfIOf0kEGcHovA4U7+npC9aQXy18M/pVdJjG+Q2msdOc9PUem2/
# AsLJvMkQ/lDXR3sdn+ia2NBsJF4PdHVt9mVuLUvIkDFRCsLcOijrq6294VPwkYsN
# ZNDAtKleKTZRH0Eyb393hSWMEiJmPjgwSh7/Nv4YqCdPO86WcXutG2WrgGNEawQR
# E4lLNzgf02W0o9EaJZ1ZKMevYmfOe1RGo3EYM6OpB22sjEX9XqkVSrbnebjJekd/
# fkSPQHfGDGANNFWKkgIcTHhCA8MxrIEeJC5bCxv0Zcg0qU61EsB9TD/qldxRM1lw
# 54eE3r924Y3mW0zvWxbfOcCWVZqo9iA=
