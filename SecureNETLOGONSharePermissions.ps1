...
#
#
#  Name: SecureNETLOGONSharePermissions
#  Ver.: 1
#  Auth: Jacob Pagano
#  Notes:
#		Requires PS v3.0
#  Description:
#       This removes the default "Everyone" ACL on NETLOGON and SYSVOL and adds other ACLs in its place. The purpose behind this
#		is to ensure confidentiality on domain network shares.
#
#
#
#
...
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "SYSTEM" -Confirm:$false -AccessRight Full | Out-Null
Revoke-SmbShareAccess -Name "NETLOGON" -AccountName "Everyone" -Confirm:$false | Out-Null
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "Authenticated Users" -Confirm:$false -AccessRight Read | Out-Null
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "NETLOGON Share Rights - Modify" -Confirm:$false -AccessRight Change | Out-Null
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "NETLOGON Share Rights - Full Control" -Confirm:$false -AccessRight Full | Out-Null
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "Domain Admins" -Confirm:$false -AccessRight Full | Out-Null
Grant-SmbShareAccess -Name "NETLOGON" -AccountName "$ForestNetBiosName\Enterprise Admins" -Confirm:$false -AccessRight Full | Out-Null

$Report = Get-SmbShareAccess -Name "NETLOGON" | Select Name,AccountName,AccessControlType,AccessRight

$Report | Write-Output | Export-Excel "\\$Domain\NETLOGON\Reports\NETLOGONSMBShareAccess\$env:computername.xlsx"

# SIG # Begin signature block
# MIISEwYJKoZIhvcNAQcCoIISBDCCEgACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoWcQyPPaLpE9tfsTkTvGV30Z
# aWuggg9rMIIHsTCCBZmgAwIBAgITNQAAACFv8bfVN7E2EQAAAAAAITANBgkqhkiG
...
# IwYJKoZIhvcNAQkEMRYEFDMPg11k64Y3TVEtYeJCQMnr07WYMA0GCSqGSIb3DQEB
# AQUABIIBAA2AbR8XbPTkjyWlH+CQI1bbpkeJBvGgZznsITECqBcAwUvymGF54PFs
# oq0yS573MdXk8weYvxJ8b4hycg9mN3InYuqlADA0wQ/yN59J5ZyVmfQ/gwYmO5ho
# bsBIfY2Dq03XcGQ5bnaK7UZVOAHY4FW/3aCDdbLB1diGUPqERy1/qImM1irZ61nz
# 5MEb+JAGmz6szIeI+jqhWB1ZTsJkOeDXa1N+BUlRUqK18/AJ83EGmpxg1fWBWLt4
# FzP0xw8l12HL2tRi8IJi+LldIg6lf4JfZY/AYwmjklbmUe3KrGfaJ3f68zBP34J1
# e6hl73H4Y2x62t3Bczdl0cRSOqcLZH0=
